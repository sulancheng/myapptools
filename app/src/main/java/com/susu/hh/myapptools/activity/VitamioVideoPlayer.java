...
import com.susu.hh.myapptools.ui.VitamioVideoView;
    ...
    private void playPreVideo() {
        if (mediaItems != null && mediaItems.size() > 0) {
            ...
            if (position >= 0) {
                ...
                isNetUri = CommenUtils.isNetUri(mediaItem.getData());
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SHOW_SPEED://显示网速
                    //1.得到网络速度
                    String netSpeed = CommenUtils.getNetSpeed(VitamioVideoPlayer.this);
                ...
                case PROGRESS:
                    ...
                    //更新文本播放进度
                    tvCurrentTime.setText(CommenUtils.stringForTime(currentPosition));
...
//        videoview.setMediaController(new MediaController(this));
    ...
    private void setData() {
        ...
        if (mediaItems != null && mediaItems.size() > 0) {
            ...
            isNetUri = CommenUtils.isNetUri(uri.toString());
...
//                Toast.makeText(SystemVideoPlayer.this, "我被双击了", Toast.LENGTH_SHORT).show();
            ...
            public boolean onSingleTapConfirmed(MotionEvent e) {
                MediaController mediaController = new MediaController(VitamioVideoPlayer.this);
...
//                    Toast.makeText(SystemVideoPlayer.this, "卡结束了", Toast.LENGTH_SHORT).show();
    ...
    class MyOnPreparedListener implements MediaPlayer.OnPreparedListener {
        ...
        public void onPrepared(MediaPlayer mp) {
            ...
            tvDuration.setText(CommenUtils.stringForTime(duration));
